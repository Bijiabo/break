...
define([], function () {
    ...
    // 下发指令方法
    var generateTargetData = function (command, additionalCommandKey, customPackageFunction) {
    ...
    var run = function (command, additionalCommandKey, customPackageFunction) {
        ...
        //     console.log('%c[runCommand-customPackageData]\n'+JSON.stringify(packagedData, null, '\t'), "font-size:1em; background-color: #FFEA88; color: #3E5266; ");
        // }
        var packagedData = generateTargetData(command, additionalCommandKey, customPackageFunction);
    ...
    var command = {
        ...
        * */
        add: function (commandName, data, additionalCommandKey, customPackageFunction) {
            ...
            Object.defineProperty(
                commandManager,
                '_raw_data_'+commandName,
                {
                    get: function() {
                        return generateTargetData(data, additionalCommandKey, customPackageFunction);
                    }
                }
            );
        }
