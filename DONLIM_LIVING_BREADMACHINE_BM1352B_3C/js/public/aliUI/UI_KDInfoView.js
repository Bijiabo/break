...
define(['./../vue', './public'], function(Vue, _public){
    ...
    var KDInfoView = Vue.extend({
        template: '<div :class="[show ? \'\' : \'hide\' ]" :e="enable">\
                        <div class="kd-info-view flex-left units-gap top-gap">\
                            <div class="info-container">\
                                ...
                                <div class="link-button status-container" v-if="displayData.isWorking" v-tap="directToWorkPage">\
                            ...
                            <div class="product-image">\
                                <img alt="xcatliu" src="https://img.alicdn.com/imgextra/i2/176994656/TB2FXMPlB8lpuFjy0FnXXcZyXXa_!!176994656.png" width="120"/>\
                            </div>\
                        </div>\
                    </div>',
        data: function() {
        ...
        methods: {
            directToWorkPage: function () {
                DA.loadPage('work/app.html');
            }
        },
        computed: {
            show: function() {
