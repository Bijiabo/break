...
define([
        ...
        './upt-template',
        'user','Q' // 获取用户数据
    ], function(underscore, Vue, vueTap, aliUI, platform, template, user, Q) {
    ...
    var version = 'A4 (2017.04.26.12.51)';
    ...
    // 设定模拟设备参数修改便捷方法
    window.updateDeviceData = function(targetKey, targetValue) {
        window.context.$set('data.' + targetKey, targetValue);
    };
    ...
    var Container = Vue.extend({
        ...
        init: function() {
            ...
            // window.data.WorkMode = ''; //todo: delete this test value
            ...
            dataUpdated: function(){
                ...
                if (Object.prototype.toString.call( appConfig.direction ) === '[object Array]') {
                    for(var i=0,len=appConfig.direction.length; i<len; i++) {
                        ...
                        if (currentDirectionConfig.condition(data, this)) {
